...
import laba.laba.server.PcapHandler;
import laba.laba.server.PcapPktHdr;
import laba.laba.server.PcapStat;
...
public interface pcap_mapping {
    ...
    int pcap_lookupnet(Pointer<Byte> src, Pointer<Integer> var1, Pointer<Integer> var2, Pointer<Byte> var3);
    ...
    Pointer<pcap> pcap_open_live(Pointer<Byte> src, int snaplen, int promisc, int timeout, Pointer<Byte> errbuf);
    ...
    Pointer<pcap> pcap_open_offline_with_tstamp_precision(Pointer<Byte> p, int var1, Pointer<Byte> var2);
    ...
    int pcap_next_ex(Pointer<pcap> p, Pointer<? extends Pointer<PcapPktHdr>> pkthdr_p, Pointer<? extends Pointer<Byte>> buf);
    ...
    int pcap_compile(Pointer<pcap> p, Pointer<bpf_mapping.bpf_program> program, Pointer<Byte> filter, int var1, int var2);

    @NativeFunction("(i32i32u64:${bpf_program}u64:u8i32u32)i32")
    int pcap_compile_nopcap(int var1, int var2, Pointer<bpf_mapping.bpf_program> program, Pointer<Byte> filter, int var3, int var4);
    ...
    int pcap_offline_filter(Pointer<bpf_mapping.bpf_program> program, Pointer<PcapPktHdr> pkthdr_p, Pointer<Byte> filter);
